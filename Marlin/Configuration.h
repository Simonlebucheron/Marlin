...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    // Ender 3 v2
    #define DEFAULT_Kp  44.11
    #define DEFAULT_Ki   8.23
    #define DEFAULT_Kd  59.10
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Ender 3 V2
  #define DEFAULT_bedKp 156.88
  #define DEFAULT_bedKi  29.71
  #define DEFAULT_bedKd 552.23
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 408.60 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -4, -2.30 }
...
#define X_BED_SIZE 225 // 235-2*5 mm
#define Y_BED_SIZE 225 // 235-2*5 mm

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -1 //Xsensor position at +4, 5 mm of bed clearance
#define Y_MIN_POS -1 //Ysensor position at +4, 5 mm of bed clearance
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE + 21 //X_BED_SIZE+5+16
...
#define PREHEAT_3_TEMP_CHAMBER 20
#define PREHEAT_3_FAN_SPEED    51 // Value from 0 to 255
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { { X_MAX_POS - 10, Y_MIN_POS + 15, (Z_MIN_POS + 1) } }
  #define NOZZLE_CLEAN_END_POINT   { { X_MAX_POS, Y_MIN_POS + 30, (Z_MIN_POS + 1) } }

  // Circular pattern radius
  #define NOZZLE_CLEAN_CIRCLE_RADIUS 10
  // Circular pattern circle fragments number
  #define NOZZLE_CLEAN_CIRCLE_FN 5
